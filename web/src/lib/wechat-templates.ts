...
const tutorialStyles: Record<string, string> = {
  ...
  p: 'font-size: 15px; color: #333333; line-height: 1.8; margin: 10px 0;',
  ...
  li: 'font-size: 15px; line-height: 1.8; margin: 4px 0; color: #333333;',
...
const narrativeStyles: Record<string, string> = {
  ...
  p: 'font-size: 17px; color: #3b3b3b; line-height: 2; margin: 12px 0; text-indent: 0;',
  ...
  li: 'font-size: 17px; line-height: 2; margin: 6px 0; color: #3b3b3b;',
...
const opinionStyles: Record<string, string> = {
  ...
  p: 'font-size: 16px; color: #2c2c2c; line-height: 1.8; margin: 10px 0;',
  ...
  li: 'font-size: 16px; line-height: 1.8; margin: 4px 0; color: #2c2c2c;',
